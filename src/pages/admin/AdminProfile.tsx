...
import { Mail, Lock, Edit2, Save, X, AlertTriangle, CheckCircle2 } from "lucide-react";
...
export function AdminProfileSettings() {
  ...
  const onPhotoSelect = async (file: File) => {
    ...
    try {
      ...
      setProfile((p) => p ? { ...p, avatar: data.photo } : p);
      setForm((f) => f ? { ...f, avatar: data.photo } : f);
  ...
  return (
    <div>
      <PageHeader title="Admin Profile & Settings" subtitle="Manage your account settings and preferences" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="p-6 lg:col-span-1">
          <div className="text-center">
            ...
            <Badge variant="indigo" className="mt-2">{profile.role.toUpperCase()}</Badge>
